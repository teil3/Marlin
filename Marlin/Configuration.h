...
#define CUSTOM_MACHINE_NAME "Teilmachr3.1d"
...
#define HOTEND_OFFSET_X {0.0, 31.00} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 6, 20 }
