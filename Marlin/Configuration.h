...
#define CUSTOM_MACHINE_NAME "Teilmachr3.19d"
...
#define HOTEND_OFFSET_X {0.0, 30.0} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,3200,192}  // default steps per unit for 3.19
